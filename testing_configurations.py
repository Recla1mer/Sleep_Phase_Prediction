...
default_gif_SAE_path = "Default_GIF_SAE_Data_All/"
...
if True:
    ...
    Reduced_Process_GIF_SAE_Dataset(
        ...
        path_to_save_processed_data = default_gif_SAE_path,
        path_to_project_configuration = limited_project_configuration_file
        )
...
def train_and_test_local_short_sequence_model_on_sleep_staging_data():
...
def train_and_test_long_sequence_model_on_apnea_events():
    ...
    del sampling_frequency_parameters, signal_cropping_parameters, padding_parameters, value_mapping_parameters, pid_distribution_parameters, dataset_class_transform_parameters, window_reshape_parameters, signal_normalization_parameters, neural_network_model_parameters, filter_gif_data_parameters, gif_error_code_1, gif_error_code_2, gif_error_code_3, gif_error_code_4, gif_error_code_5
    ...
    if not os.path.exists(gif_directory_path):
        copy_and_split_default_database_SAE(
            path_to_default_gif_database = default_gif_SAE_path,
            path_to_save_gif_database = gif_directory_path,
            project_configuration = default_project_configuration
        )
...
def train_and_test_local_short_sequence_model_on_apnea_events():
